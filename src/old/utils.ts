 ...
 */
 export function set(obj: { [char: string]: any }, keys: any[], value: any): { [char: string]: any } {
 ...
 */
export function get(obj: { [char: string]: any }, keys: any[], def: any = undefined): { [char: string]: any } {
  const tmp = obj[keys[0]];
